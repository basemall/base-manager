package com.ibase.mall.manager.init;
...
@Configuration
@MapperScan(basePackages = {"com.ibase.mall.manager.dao"}, sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig {
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception {
		...
		factoryBean.setTypeAliasesPackage("com.ibase.mall.manager.entity");
